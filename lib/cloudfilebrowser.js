/*
    ...
    Cloud Elements HTML5 FilePicker 
    
    Author: phil@cloud-elements.com
    Date: 4/9/2014

    The following script is a module designed for file listing, sorting,
    and uploading via HTML5 drag-drop and JavaScript events. 
    ...
    return {
        ...
        bindProvisionButtons: function() {
            ...
            $('.provision').on('click', function() {
                ...
                filePicker.provisionEl(element);
            });
        ...
        bindFileInfo: function(element) {
            ...
            $('.listTable ul li.foldername').on('click', function() {
                ...
                provision.getDocuments(element, location, function(data, cbArgs) {
                    filePicker.drawEl(data, cbArgs.element, cbArgs.path);
                }, callbackArgs);
            });
        ...
        provisionEl: function(element) {
            ...
            provision.createInstance(element, filePicker.handleOnProvision, callbackArgs);
        },
...
//                tableHTML += '</ul></div>';
                ...
                for (var i=0; i < obj.length; i++) {
                    ...
                    tableHTML += '<ul draggable="true"><li class="checkbox"></li>';
        ...
        bindFileDragDrop: function() {
            ...
            $('.drop-zone').on('drop', function(e) {
                ...
                filePicker.uploadFiles(files, element);
