...
var cloudFileBrowser = (function() {
    ...
    return {
        ...
        buildDomEls: function(selector, cb) {
            ...
            var HTML = '<section id="tab-container"><ul id="services-tabs"></ul><section id="services-containers"></section><section id="file-info"><div class="preview"></div><h2>File Details</h2><div class="fileDetails"></div></section></section><section id="loading"><span><i></i></span></section><section id="error"></section>';
        ...
        buildTable: function(data, isNew, path, element) {
            ...
            if (isNew == true) {
                ...
                tableHTML += '<input type="file" class="hidden addFiles"></input><a class="addFilesButton" href="#">Add Files</a><div class="breadcrumb">' +
                    '<ul>';
...
//- styling of download & upload [Phil]
//- Display of image for the selected file [Phil]
...
//- Example 1 - To use the CloudFileBrowser as is  [Phil]
//- Example 2 - To use the CloudFileBrowser in a modal window  [Phil]
//- Implement Uploading of files  [Ramana]
//
//Current Defects
//- Doesnt work in Safari [Phil]
//- List scrolling doesnt work [Phil]
//- File details close doesnt work [Phil]
