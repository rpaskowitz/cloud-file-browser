    ...
    return {
        ...
        bindFileInfo: function(element) {
            ...
            $('.listTable ul li.filename').on('click', function() {
                ...
                provision.displayThumbnail(element, location);
        ...
        buildTable: function(data, isNew, path, element) {
            ...
            if (isNew == true) {
                ...
                tableHTML += '<input type="file" class="hidden addFiles" multiple></input><a class="addFilesButton" href="#">Add Files</a><div class="breadcrumb">' +
                    '<ul>';
